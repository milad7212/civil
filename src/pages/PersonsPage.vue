<template>
  ...
  <div class="container mx-auto py-8">
    ...
    <div class="flex items-center mb-4">
      <label for="search" class="text-gray-800 font-semibold mr-4"
    ...
    <div class="mt-8">
      ...
      <div class="flex flex-wrap -mx-2">
        <button
          ...
          :key="index"
          @click="setFilter(specialty, 'specialty')"
          :class="[
            'px-4 py-2 rounded-full text-sm font-medium mr-2 mb-2',
    ...
    filteredPersons() {
      if (this.activeFilter === "All") {
        ...
        return this.persons.filter(
          (person) =>
            person.specialties.includes(this.activeFilter) &&
            person.name.toLowerCase().includes(this.searchQuery.toLowerCase())
        );
      }
    },
